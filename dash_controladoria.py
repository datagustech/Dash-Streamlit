...
if add_selectbox == 'Últimos 5 meses':
    ...
    with st.container(border=True):
        ...
        fat_mes_formatado = "R${:.2f}".format(fat_mes).replace(",", ";").replace(".", ",").replace(";", ".")
        ...
        fig2 = px.line(count_by_month, x='Data de Emissão', y='ID Nota Fiscal',
                       title='Distribuição de Notas Fiscais ao Longo do Tempo',
        ...
        fig4 = px.bar(soma_valores, x='UF do Cliente', y='Valor da Nota',
                      ...
                      category_orders={
                          'UF do Cliente': soma_valores.sort_values('Valor da Nota', ascending=False)['UF do Cliente']})
...
if add_selectbox == 'Julho':
    ...
    with st.container(border=True):
        ...
        col1.markdown(
            f'<p style="font-size:40px; text-align:center; margin-top:150px; font-family:sans-serif; font-weight:bold; border:8px solid #ccc; border-radius:10px; padding:50px;">Faturamento Julho: {fat_mes_formatado}</p>',
            unsafe_allow_html=True)
        ...
        fig1_julho = px.histogram(filtered_value, x='Valor da Nota',
                                  title='Distribuição dos Valores das Notas Fiscais - Julho',
                                  labels={'Valor da Nota': 'Valores das Notas'})
        ...
        fig3_julho = px.bar(df_sem_duplicatas_julho, x='UF do Cliente',
                            ...
                            labels={'count': 'Número de Notas Fiscais', 'UF do Cliente': 'UF do Cliente'},
                            category_orders={
                                'UF do Cliente': df_sem_duplicatas_julho['UF do Cliente'].value_counts().index})
        ...
        fig4_julho = px.bar(soma_valores_julho, x='UF do Cliente', y='Valor da Nota',
                            ...
                            labels={'Valor da Nota': 'Valor Total', 'UF do Cliente': 'UF do Cliente'},
                            category_orders={
                                'UF do Cliente': soma_valores_julho.sort_values('Valor da Nota', ascending=False)[
                                    'UF do Cliente']})
        ...
        faturamento_total_julho['Participacao'] = faturamento_total_julho['Valor da Nota'] / faturamento_total_julho[
...
#
    ...
    with st.container(border=True):
        ...
        fat_mes_formatado = locale.currency(fat_mes, grouping=True)
        col1.markdown(
            f'<p style="font-size:40px; text-align:center; margin-top:150px; font-family:sans-serif; font-weight:bold; border:8px solid #ccc; border-radius:10px; padding:50px;">Faturamento Agosto: {fat_mes_formatado}</p>',
            unsafe_allow_html=True)
        # Seção 1: Histograma dos Valores das Notas Fiscais
        filtered_value = df_sem_duplicatas_Agosto[df_sem_duplicatas_Agosto['Valor da Nota'] < 10000]
        fig1_Agosto = px.histogram(filtered_value, x='Valor da Nota',
                                   title='Distribuição dos Valores das Notas Fiscais - Agosto',
                                   labels={'Valor da Nota': 'Valores das Notas'})
        ...
        fig3_Agosto = px.bar(df_sem_duplicatas_Agosto, x='UF do Cliente',
                             ...
                             labels={'count': 'Número de Notas Fiscais', 'UF do Cliente': 'UF do Cliente'},
                             category_orders={
                                 'UF do Cliente': df_sem_duplicatas_Agosto['UF do Cliente'].value_counts().index})
        ...
        fig4_Agosto = px.bar(soma_valores_Agosto, x='UF do Cliente', y='Valor da Nota',
                             ...
                             labels={'Valor da Nota': 'Valor Total', 'UF do Cliente': 'UF do Cliente'},
                             category_orders={
                                 'UF do Cliente': soma_valores_Agosto.sort_values('Valor da Nota', ascending=False)[
                                     'UF do Cliente']})
        ...
        faturamento_total_Agosto['Participacao'] = faturamento_total_Agosto['Valor da Nota'] / faturamento_total_Agosto[
            'Valor da Nota'].sum() * 100
...
# Seção específica para 'Setembro'
    ...
    with st.container(border=True):
        ...
        fat_mes_formatado = locale.currency(fat_mes, grouping=True)
        col1.markdown(
            f'<p style="font-size:40px; text-align:center; margin-top:150px; font-family:sans-serif; font-weight:bold; border:8px solid #ccc; border-radius:10px; padding:50px;">Faturamento Setembro: {fat_mes_formatado}</p>',
            unsafe_allow_html=True)
        # Seção 1: Histograma dos Valores das Notas Fiscais
        filtered_value = df_sem_duplicatas_setembro[df_sem_duplicatas_setembro['Valor da Nota'] < 10000]
        fig1_setembro = px.histogram(filtered_value, x='Valor da Nota',
                                     title='Distribuição dos Valores das Notas Fiscais - Setembro',
                                     labels={'Valor da Nota': 'Valores das Notas'})
        ...
        fig3_setembro = px.bar(df_sem_duplicatas_setembro, x='UF do Cliente',
                               ...
                               labels={'count': 'Número de Notas Fiscais', 'UF do Cliente': 'UF do Cliente'},
                               category_orders={
                                   'UF do Cliente': df_sem_duplicatas_setembro['UF do Cliente'].value_counts().index})
        ...
        fig4_setembro = px.bar(soma_valores_setembro, x='UF do Cliente', y='Valor da Nota',
                               ...
                               labels={'Valor da Nota': 'Valor Total', 'UF do Cliente': 'UF do Cliente'},
                               category_orders={
                                   'UF do Cliente': soma_valores_setembro.sort_values('Valor da Nota', ascending=False)[
                                       'UF do Cliente']})
        ...
        faturamento_total_setembro['Participacao'] = faturamento_total_setembro['Valor da Nota'] / \
                                                     faturamento_total_setembro['Valor da Nota'].sum() * 100
...
# Seção específica para 'Outubro'
    ...
    with st.container(border=True):
        ...
        fat_mes_formatado = locale.currency(fat_mes, grouping=True)
        col1.markdown(
            f'<p style="font-size:40px; text-align:center; margin-top:150px; font-family:sans-serif; font-weight:bold; border:8px solid #ccc; border-radius:10px; padding:50px;">Faturamento Outubro: {fat_mes_formatado}</p>',
            unsafe_allow_html=True)
        # Seção 1: Histograma dos Valores das Notas Fiscais
        filtered_value = df_sem_duplicatas_outubro[df_sem_duplicatas_outubro['Valor da Nota'] < 10000]
        fig1_outubro = px.histogram(filtered_value, x='Valor da Nota',
                                    title='Distribuição dos Valores das Notas Fiscais - Outubro',
                                    labels={'Valor da Nota': 'Valores das Notas'})
        ...
        fig3_outubro = px.bar(df_sem_duplicatas_outubro, x='UF do Cliente',
                              ...
                              labels={'count': 'Número de Notas Fiscais', 'UF do Cliente': 'UF do Cliente'},
                              category_orders={
                                  'UF do Cliente': df_sem_duplicatas_outubro['UF do Cliente'].value_counts().index})
        ...
        fig4_outubro = px.bar(soma_valores_outubro, x='UF do Cliente', y='Valor da Nota',
                              ...
                              labels={'Valor da Nota': 'Valor Total', 'UF do Cliente': 'UF do Cliente'},
                              category_orders={
                                  'UF do Cliente': soma_valores_outubro.sort_values('Valor da Nota', ascending=False)[
                                      'UF do Cliente']})
        ...
        faturamento_total_outubro['Participacao'] = faturamento_total_outubro['Valor da Nota'] / \
                                                    faturamento_total_outubro['Valor da Nota'].sum() * 100
...
# Seção específica para 'Novembro'
    ...
    with st.container(border=True):
        ...
        fat_mes_formatado = locale.currency(fat_mes, grouping=True)
        col1.markdown(
            f'<p style="font-size:40px; text-align:center; margin-top:150px; font-family:sans-serif; font-weight:bold; border:8px solid #ccc; border-radius:10px; padding:50px;">Faturamento Novembro: {fat_mes_formatado}</p>',
            unsafe_allow_html=True)
        # Seção 1: Histograma dos Valores das Notas Fiscais
        filtered_value = df_sem_duplicatas_novembro[df_sem_duplicatas_novembro['Valor da Nota'] < 10000]
        fig1_novembro = px.histogram(filtered_value, x='Valor da Nota',
                                     title='Distribuição dos Valores das Notas Fiscais - Novembro',
                                     labels={'Valor da Nota': 'Valores das Notas'})
        ...
        fig3_novembro = px.bar(df_sem_duplicatas_novembro, x='UF do Cliente',
                               ...
                               labels={'count': 'Número de Notas Fiscais', 'UF do Cliente': 'UF do Cliente'},
                               category_orders={
                                   'UF do Cliente': df_sem_duplicatas_novembro['UF do Cliente'].value_counts().index})
        ...
        fig4_novembro = px.bar(soma_valores_novembro, x='UF do Cliente', y='Valor da Nota',
                               ...
                               labels={'Valor da Nota': 'Valor Total', 'UF do Cliente': 'UF do Cliente'},
                               category_orders={
                                   'UF do Cliente': soma_valores_novembro.sort_values('Valor da Nota', ascending=False)[
                                       'UF do Cliente']})
        ...
        faturamento_total_novembro['Participacao'] = faturamento_total_novembro['Valor da Nota'] / \
                                                     faturamento_total_novembro['Valor da Nota'].sum() * 100
